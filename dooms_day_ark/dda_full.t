...
shots := sum 1d6;
hits := sum shots#call HitRROne( 1 d6, HitOn, ReRollOneToHit, Mephrit);
wounds := sum hits#call WoundCheck( 1 d6, WoundOn);
pens := sum wounds#call SaveCheck(1 d6, SaveOn);
damage := sum pens#call Damage(FullPower);
damage
